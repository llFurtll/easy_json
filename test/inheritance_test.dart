...
void main() {
  group('Herança de Classes (Inheritance)', () {
    test('deve serializar campos da classe pai e da classe filha corretamente', () {
    ...
    test('fromJsonSafe: deve aplicar validações e defaults nos campos herdados', () {
      final issues = <EasyIssue>[];
      final json = {
        'base_id': 12345, // tipo incorreto, deve gerar issue e usar fallback (string vazia)
